...
<div class="max-w-5xl mx-auto animate-fade-in">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('home') }}" class="inline-flex justify-center items-center gap-2 px-4 py-2 bg-white border border-calm-200 hover:bg-calm-50 text-calm-700 rounded-xl font-medium transition-colors shadow-sm w-full sm:w-auto flex-shrink-0">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($educations as $edu)
            <a href="{{ route('education.show', $edu->slug) }}" class="group bg-white rounded-2xl shadow-card border border-calm-100 hover:shadow-card-hover hover:border-primary-200 transition-all duration-300 overflow-hidden flex flex-col">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    <p class="text-sm text-calm-600 line-clamp-3 mb-4 leading-relaxed">
                        {{ Str::limit(strip_tags($edu->content), 150) }}
                    </p>
