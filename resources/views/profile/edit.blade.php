        ...
        <div class="p-6 space-y-8">
            ...
            <div id="keamanan" class="tab-content hidden">
                ...
                @if(auth()->user()->google_id)
                    ...
                    <div class="bg-primary-50 border border-primary-200 rounded-xl p-5 flex items-start gap-4 mb-6">
                        <div class="w-10 h-10 flex-shrink-0 rounded-full bg-white border border-primary-100 flex items-center justify-center shadow-sm">
                        ...
                        <div>
                            <p class="font-semibold text-calm-900 text-sm">Akun terhubung dengan Google</p>
                            <p class="text-sm text-calm-600 mt-1">Keamanan akunmu dikelola langsung oleh Google. Ubah password melalui pengaturan akun Google kamu di <a href="https://myaccount.google.com/security" target="_blank" class="text-primary-600 underline">myaccount.google.com</a>.</p>
                        </div>
                    </div>
                @else
                    ...
                    <div class="flex items-center justify-between p-3 bg-white rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-calm-500">Browser • Aktif sekarang</p>
                            </div>
                        </div>
                        <span class="px-2 py-1 bg-primary-50 text-primary-700 text-xs font-semibold rounded-full">Aktif</span>
                    </div>
                    <p class="text-xs text-calm-500 mt-3">Sesi berakhir otomatis setelah 2 jam tidak ada aktivitas.</p>
                </div>
            </div>
