...
<div class="space-y-0.5">
    <p class="px-2 pt-1 pb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-400">Admin</p>
    ...
    <a href="{{ route('admin.educations') }}" class="nav-item {{ request()->routeIs('admin.educations*') ? 'active' : '' }}">
